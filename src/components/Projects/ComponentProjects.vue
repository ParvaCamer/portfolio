<template>
    <div class="display-projects-container">
        <div class="display-projects-display">
            ...
            <div class="display-projects-bottom">
                <base-button @click="toggleDisplay">
    ...
    .display-projects-display {
        ...
        .image-div {
            ...
            img {
                border-radius: 6px;
                width: 80%;
                box-shadow: 10px 20px 20px #5d6666,
                    -10px -20px 20px #829a9a;
            }
