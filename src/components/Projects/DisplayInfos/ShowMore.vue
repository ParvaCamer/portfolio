    ...
    <div class="card-show-more">
        ...
        <div class="right-side">
            ...
            <div class="vfor-languages">
                <p v-for="language in languages" :key="language.id" class="languages" :class="language">
                    {{ language }}
                </p>
            </div>
        </div>
...
.card-show-more {
    ...
    &.active {
        position: fixed;
        z-index: 15;
        animation: anim-in 0.7s cubic-bezier(0.470, 0.000, 0.745, 0.715) both;
    }
